                  ...
                  <form action="" method="POST" onsubmit="return checkout()">
                      <div class="mb-3">
                          <div class="form-check">
                            ...
                            <div class="form-check">
                            <input class="form-check-input" type="radio" name="payment" id="wave" checked value="wavepay">
                    ...
                    {{-- if the customer does not login so he need to go login page --}}
                    @guest
...
<script>
    function checkout()
    {
        ...
        let itemstring=localStorage.getItem('bookCart');//Shopping Cart storage from cart js
    ...
    //send ajax to checkout, in other words we can store the data in orders.store
